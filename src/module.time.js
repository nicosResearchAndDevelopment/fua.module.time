...
module.exports = (
    ...
    function getTemporalEntity(parameter) {
        ...
        switch (typeof parameter) {
            case "object":
                if (parameter['@type'] === "xsd:dateTimeStamp") {
                    temporalEntity = new Instant(parameter['@value']);
                } else if (parameter['@type'] === "time:ProperInterval") {
                    temporalEntity = new ProperInterval(parameter['@value']['hasBeginning'], parameter['@value']['hasEnd']);
                } // if ()
                break;
            case "string":
            default:
    ...
    //function getTemporalEntity(value) {
    //
    //    return (
    //        (typeof value === "string")
    //            ?
    //            (
    //                ((value === "now") || (value === "time:now"))
    //                    ?
    //                    now()
    //                    :
    //                    Instant(value)
    ...
    //            :
    //            (
    //                ((value['@type'] === "xsd:dateTimeStamp") || (value['@type'] === "time:Instant") || (value['@type'] === "Instant"))
    //                    ?
    //                    Instant((value['@value'] || value['hasBeginning'] || value['hasEnd']))
    //                    :
    //                    (
    //                        ((value['@type'] === "time:ProperInterval") || (value['@type'] === "ProperInterval"))
    //
    //                            ?
    //                            new module['ProperInterval'](/** xsd:dateTimeStamp|xsd:duration */ value['hasBeginning'], /** xsd:dateTimeStamp|xsd:duration */ value['hasEnd'])
    //                            :
    //                            null
    //                    )
    //            )
