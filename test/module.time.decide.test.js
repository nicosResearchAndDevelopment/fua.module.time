...
describe('time.Before', () => {

    test('should accept exactly 2 temporal entites as arguments.', () => {
    ...
    test('should return true if left argument comes before the right argument.', () => {
...
describe('time.After', () => {
    ...
    test('should return true if left argument comes after the right argument.', () => {
...
describe('time.Meets', () => {
    ...
    test('should return true if left argument comes immediatly before the right argument.', () => {
...
describe('time.MetBy', () => {
    ...
    test('should return true if left argument comes immediatly after the right argument.', () => {
...
describe('time.Overlaps', () => {
    ...
    test('should return true if left argument comes before the right argument and overlaps.', () => {
...
describe('time.OverlappedBy', () => {
    ...
    test('should return true if left argument comes after the right argument and overlaps.', () => {
...
describe('time.Starts', () => {
    ...
    test('should return true if left argument is the start of the right argument.', () => {
...
describe('time.StartedBy', () => {
    ...
    test('should return true if left argument starts with the right argument.', () => {
...
describe('time.During', () => {
    ...
    test('should return true if left argument is enclosed by the right argument.', () => {
...
describe('time.Contains', () => {
    ...
    test('should return true if left argument encloses the right argument.', () => {
...
describe('time.Finishes', () => {
    ...
    test('should return true if left argument is the ending of the right argument.', () => {
...
describe('time.FinishedBy', () => {
    ...
    test('should return true if left argument ends with the right argument.', () => {
...
describe('time.Equals', () => {
    ...
    test('should return true if left argument matches onto the right argument.', () => {
...
describe('time.In', () => {
    ...
    test('should return true if left argument fits somewhere on the right argument.', () => {
...
describe('time.Disjoint', () => {
    ...
    test('should return true if left argument does not touch the right argument.', () => {
